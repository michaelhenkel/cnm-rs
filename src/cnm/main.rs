...
use cnm_rs::controllers::{
    ...
    crpd::routing_instance_group::RoutingInstanceGroupController,
    pool::PoolController,
...
async fn main() -> anyhow::Result<()> {
    ...
    let resource_list: Vec<Box<dyn resources::resources::Resource>> = vec![
        ...
        Box::new(resources::routing_instance_group::RoutingInstanceGroupResource::new(client.clone())),
    ...
    let controller_list: Vec<Box<dyn controllers::Controller>> = vec![
        ...
        Box::new(RoutingInstanceGroupController::new(ctx.clone())),
